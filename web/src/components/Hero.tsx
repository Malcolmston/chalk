...
// Hero renders the chalk library hero: icon, name, module path, tagline and the
// action row (GitHub, API docs, live version badge, "ports chalk/chalk").
    ...
    <div className="libhero" style={{ '--lib-soft': hx(lib.accent, '1f'), '--lib-accent': lib.accent } as CSSProperties}>
      <div className="row">
        ...
        <div style={{ flex: 1, minWidth: 220 }}>
          ...
          <p className="tagline" dangerouslySetInnerHTML={{ __html: lib.tagline }} />
        </div>
      </div>
      <div className="actions">
        <a className="pill b" href={lib.repo} target="_blank" rel="noopener"><i className="fa-brands fa-github" />&nbsp;GitHub</a>
        <a className="pill b" href="./api/"><i className="fa-solid fa-book" /> API docs</a>

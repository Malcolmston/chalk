...
const TABS: Tab[] = [
  { id: 'overview', label: 'Overview', dot: CHALK.accent },
...
export function App() {
  ...
  const brand = { title: 'malcolmston', sub: '/chalk', initials: 'ch', href: '#overview' };
  const footer: ReactNode = (
    <div>
      <span className="grad-text" style={{ fontWeight: 700 }}>malcolmston/chalk</span> — terminal string styling for Go, plus prompts &amp; figlet.
      <div className="small dim" style={{ marginTop: '.4rem' }}>MIT licensed · independent re-implementation of chalk/chalk</div>
    </div>
  );

  return (
    <Layout brand={brand} tabs={TABS} active={active} onNav={go} github={CHALK.repo} footer={footer}>
